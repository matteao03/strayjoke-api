...
use App\Http\Requests\Lawyer\AuthInfoRequest;
...
use App\Transformers\Lawyer\LawyerCheckTransformer;
...
class LawyerController extends Controller
{
    ...
    //更新律师信息
    public function updateInfo(AuthInfoRequest $request, $phone)
    {
